"""Canonical book list, matching the `books` table in initdb.d/seed.sql."""
...
BOOKS_BY_ID = {b[0]: {"id": b[0], "name": b[1], "testament": b[2], "genreId": b[3], "slug": slug(b[1])} for b in BOOKS}
